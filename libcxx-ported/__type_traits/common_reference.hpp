...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/30 01:17:16 by larlena           #+#    #+#             */
/*   Updated: 2024/06/07 12:15:33 by larlena          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef __KFS_LIBXX_PORTED___TYPE_TRAITS_COMMON_REFERENCE_HPP__
# define __KFS_LIBXX_PORTED___TYPE_TRAITS_COMMON_REFERENCE_HPP__
...
template <class _Tp, class _Up>
using __basic_common_reference_t = typename basic_common_reference<remove_cvref_t<_Tp>,
                                    remove_cvref_t<_Up>,
...
#endif // __KFS_LIBXX_PORTED___TYPE_TRAITS_COMMON_REFERENCE_HPP__
