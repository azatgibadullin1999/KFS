...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/05 21:59:27 by larlena           #+#    #+#             */
/*   Updated: 2024/06/07 12:25:52 by larlena          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */


#ifndef __KFS_LIBCXX___TUPLE_TUPLE_OWN_HPP__
# define __KFS_LIBCXX___TUPLE_TUPLE_OWN_HPP__
...
class tuple_recursive_base<I, T, Types...> :
	public tuple_element<I, typename std::remove_reference<T>::type>,
	public tuple_recursive_base<I + 1, Types...> {
public:
	using base_type = tuple_element<I, typename std::remove_reference<T>::type>;
...
public:
	...
	tuple_recursive_base<0, Types...>(std::move(args)...) { }
	...
	tuple_recursive_base<0, U1, U2>(std::move(p.first), std::move(p.second)) { }
...
template <typename ... Types>
struct tuple_size < ktl::tuple<Types...> > : public std::integral_constant<size_t, sizeof...(Types)> { };

template <size_t I, typename ... Types>
auto	&get(ktl::tuple<Types...>& t) noexcept {
	return static_cast<typename ktl::tuple_element<I, typename std::extract_type_at<I, Types...>::type>& >(t).get();
}

template <size_t I, typename ... Types>
auto	&get(const ktl::tuple<Types...>& t) noexcept {
	return static_cast<const typename ktl::tuple_element<I, typename std::extract_type_at<I, Types...>::type>& >(t).get();
}
...
#endif // __KFS_LIBCXX___TUPLE_TUPLE_OWN_HPP__
