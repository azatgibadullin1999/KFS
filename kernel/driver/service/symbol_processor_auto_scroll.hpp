...
class SymbolProcessorAutoScroll final : public kfs::SymbolProcessor <
...
> {
public:
	SymbolProcessorAutoScroll(kfs::ITextDisplay *text_display) :
	SymbolProcessor(
		CommandPressTab('\t', text_display, 8),
		CommandPressScroll(kfs::IKeyboard::Decoder::DOWN, text_display),
