...
class CommandDefaultShell final : public pattern::ICommand {
public:
	CommandDefaultShell(Container &shared_container, typename Container::iterator &shared_it, kfs::IConsole *console)
	: _character{ }
